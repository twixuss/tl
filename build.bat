...
echo main_avx...
cl %srcdir%main.cpp %srcdir%definitions.cpp /arch:AVX %cFlags% /out:main_avx.exe
if %errorlevel% neq 0 goto fail
echo main_avx2...
cl %srcdir%main.cpp %srcdir%definitions.cpp /arch:AVX2 %cFlags% /out:main_avx2.exe
if %errorlevel% neq 0 goto fail
