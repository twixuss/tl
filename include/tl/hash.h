...
inline tl::umm get_hash(void *value) { return (tl::umm)value / sizeof(void *); }
...
template <class T>
tl::umm get_hash(tl::Span<T> value) {
	tl::umm result = 0xdeadc0debabeface;
