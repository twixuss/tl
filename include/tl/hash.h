...
template <> inline constexpr tl::u64 get_hash(tl::f32   const &value) { return tl::bit_cast<tl::u32>(value); }
template <> inline constexpr tl::u64 get_hash(tl::f64   const &value) { return tl::bit_cast<tl::u64>(value); }
