...
template <class F32, class U32> forceinline F32 normalize_range_f32(U32 v) { return (F32)(v >> 8) * (1.0f / ((1 << 24) - 1)); }
template <class F64, class U64> forceinline F64 normalize_range_f64(U64 v) { return (F64)(v >> 11) * (1.0 / ((1llu << 53) - 1)); }
